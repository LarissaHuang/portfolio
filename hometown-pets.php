    ...
    <div class="row">
        <div class="col-xs-12 col-sm-6 demo">
            ...
            <div class="" data-aos="slide-right">
                <a href="http://larissahuang.ca/hometown-pets" class="btn btn-center btn-outline-secondary btn-demo" style="margin-top:30px; border:none;">View Demo</a>

                <img src="img/pets-mocks.png" class="banner" id="todo-banner" />
            </div>
        ...
        <div class="col-xs-12 col-sm-6">
            <div class="description">
                <h3 class="title">A (slightly less) simple React app</h3>
                <p class="key">Key concepts: APIs, Portals, Reach Router</p>
